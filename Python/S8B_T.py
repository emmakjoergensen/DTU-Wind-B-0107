...
recorderRS.save('S8BT' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('S8BT' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_S8BT.csv', index=False) # Coordinates will be used to plot inter array cable layout
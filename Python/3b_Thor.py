...
recorderRS.save('Scenario3b_Thor' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('Scenario3b_Thor' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_3b_Thor.csv', index=False) # Coordinates will be used to plot inter array cable layout

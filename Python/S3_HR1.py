...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 10:21:10 2024
...
recorderRS.save('S3HR1' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('S3HR1' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_S3HR1.csv', index=False) # Coordinates will be used to plot inter array cable layout
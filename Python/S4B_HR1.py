...
recorderRS.save('S4BHR1' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('S4BHR1' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_S4BHR1.csv', index=False) # Coordinates will be used to plot inter array cable layout
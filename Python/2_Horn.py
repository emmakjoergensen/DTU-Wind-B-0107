# -*- coding: utf-8 -*-
"""
Created on Fri May 24 15:00:55 2024

@author: Freja Rølle Jakobsen
"""
#-------SCENARIO 2 HORNS REV 1-------#
...
cost_comp = TopFarmGroup([aep_component, water_depth_component, support_structure_component, cost_emissions_component, LCOE_CAPEX_component, LCOE_OPEX_component, LCOE_component])
...
recorderRS.save('Scenario2_Horn' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('Scenario2_Horn' + time_stamp + '_SLSQP')

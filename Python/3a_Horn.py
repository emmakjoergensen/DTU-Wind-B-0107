...
recorderRS.save('Scenario3a_Horn' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('Scenario3a_Horn' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_3a_Horn.csv', index=False) # Coordinates will be used to plot inter array cable layout

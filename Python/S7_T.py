...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 10:50:47 2024
...
def LCOE_CAPEX(AEP, CO2e_tax, monopile_cost, cable_length, cost_cable, **kwargs):
  ...
  # Calculate cost of all capital expenditures (excl. CO2e tax)
  cost_CAPEX = cost_WT * n_wt * rated_power + monopile_cost + cost_cable # €
...
recorderRS.save('S7T' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('S7T' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_S7T.csv', index=False) # Coordinates will be used to plot inter array cable layout

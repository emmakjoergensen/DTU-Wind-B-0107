# -*- coding: utf-8 -*-
"""
Created on Fri May 24 14:53:23 2024

@author: Freja Rølle Jakobsen
"""
#-------SCENARIO 1 HORNS REV 1-------#
...
recorderRS.save('Scenario1_Horn' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('Scenario1_Horn' + time_stamp + '_SLSQP')

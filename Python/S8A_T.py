...
recorderRS.save('S8AT' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('S8AT' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_S8AT.csv', index=False) # Coordinates will be used to plot inter array cable layout
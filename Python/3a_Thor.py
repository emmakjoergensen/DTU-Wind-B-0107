...
# -*- coding: utf-8 -*-
"""
Created on Fri May 24 17:25:43 2024
...
#Fixed position for the substation, where it is originally placed 
...
recorderRS.save('Scenario3a_Thor' + time_stamp + '_RS')
...
# Save recorder to file
recorderSLSQP.save('Scenario3a_Thor' + time_stamp + '_SLSQP')
...
df.to_csv('Optimized_coordinates_3a_Thor.csv', index=False) # Coordinates will be used to plot inter array cable layout
